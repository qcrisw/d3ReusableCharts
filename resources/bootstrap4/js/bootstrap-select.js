...
(function ($) {
  ...
  var classNames = {
    ...
    BUTTONCLASS: version.major === '4' ? 'btn-outline-secondary' : 'btn-default',
  ...
  if (version.major === '4') {
    Selectpicker.DEFAULTS.style = 'btn-outline-secondary';
    Selectpicker.DEFAULTS.iconBase = 'fa';
    Selectpicker.DEFAULTS.tickIcon = 'fa-check';
  }
