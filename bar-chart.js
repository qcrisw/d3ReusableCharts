...
//   console.log(x0Scale.bandwidth(), x1Scale.bandwidth());
...
//     var rectSelection = "div"+chartId+">svg>g>g>g.data-points-groupedbar";
//     d3.selectAll(rectSelection).remove();
//     tooltip.classed('hidden', true);
//
//     g.append('g').attr("class", "data-points-groupedbar").selectAll("g").data(jsonData).enter().append('g')
//        .attr("transform", function(d) { return "translate(" + x0Scale(d.x) + ",0)"; })
//        .selectAll("rect")
//        .data(function(d) {
//          return keys.map(function(key) { return {key: key, value: d.y, color: d.color, x: d.x, enabled: d.enabled}; }); })
//        .enter().append("rect")
//       .attr("class", function(d) { return x1Scale(d.key);})
...
//     });
//
//     var tooltipHtml = "<p>"+xLabel+": <b>"+d.x+"</b></p><p>"+yLabel+": <b>"+ d.value+"</b>";
